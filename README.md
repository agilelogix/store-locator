...
For more, Please create a ticket here, we will reply ASAP https://wordpress.org/support/plugin/agile-store-locator.e finder,
...
Real Estate and Deals Maps are included in the plugin which makes it
